        ...
        <div className="h-screen bg-black">
            <div className="h-screen bg-gradient-to-r from-rose-500/50 via-transparent to-blue-600/50">
                <div className="w-screen pt-[15vh] flex justify-center gap-10">
                    <div className="profile w-[18vw] h-[50vh] reverse-diagonal-gradient rounded-3xl p-3 flex flex-col items-center justify-between text-white m-4 relative">
                    ...
                    <div className='feed w-[60vw] h-[70vh] rounded-3xl flex justify-center'>
                        <div className="suggestion w-[35%] h-[70%] bg-fuchsia-950 rounded-2xl m-3 p-3 flex justify-center flex-col items-center gap-4">
