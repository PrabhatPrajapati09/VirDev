...
const Hero_section = () => {
  return (
    <div className="relative h-auto min-h-screen bg-slate-950 overflow-hidden">
      ...
      {/* Main Content */}
      <div className="relative z-10 flex flex-col md:flex-row justify-between items-center h-full px-6 md:px-10 pt-[12vh] gap-10">
        {/* Left content */}
