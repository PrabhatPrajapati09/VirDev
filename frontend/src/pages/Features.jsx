...
const Features = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-950 flex flex-col justify-center items-center relative overflow-hidden">
      ...
      <div className="pt-[8vh] relative z-10 text-center px-4 mt-72 lg:mt-0">
        <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-tight">
          VirDev Features
        </h1>
        <h4 className="mt-4 text-base sm:text-lg md:text-xl text-white leading-relaxed max-w-[80vw] mx-auto">
          VirDev makes it easy to find your perfect virtual dev partner.
        </h4>
      </div>
      ...
      <div className="flex flex-col md:flex-row justify-between items-center w-full max-w-[1200px] px-4 md:px-6 mt-10 relative z-10 gap-8 md:gap-0">
        ...
        <div className="relative w-[80vw] sm:w-[70vw] md:w-[60vw] lg:max-w-[700px] aspect-square flex justify-center items-center">
          ...
          <div className="absolute w-[75%] sm:w-[70%] aspect-square rounded-full flex flex-col justify-center items-center text-center bg-slate-900/70 border border-slate-700 p-4 sm:p-6 shadow-xl transition-all duration-700 z-0">
            <h2 className="text-xl sm:text-2xl md:text-3xl font-extrabold text-white mb-3 sm:mb-4 transition-all duration-500">
              {steps[activeIndex].title}
            </h2>
            <p className="text-gray-300 text-xs sm:text-sm md:text-base mx-2 sm:mx-3 transition-all duration-500">
              {steps[activeIndex].desc}
            </p>
          </div>
          ...
          {steps.map((step, i) => {
            ...
            return (
              <button
                ...
                className={`absolute transition-all duration-500 transform z-20 outline-none
                  ${i === activeIndex
                    ? "scale-110 sm:scale-125 text-pink-500 bg-pink-600/30 rounded-full shadow-lg shadow-pink-500/40"
                    : "scale-90 sm:scale-100 text-gray-400 hover:text-pink-300"
                  }`}
                style={{
                  left: `calc(50% + ${x}px - 28px)`, // Adjusted for center alignment
                  top: `calc(50% + ${y}px - 28px)`,
                }}
              >
                <div className="h-14 w-14 sm:h-16 sm:w-16 flex justify-center items-center rounded-full">
